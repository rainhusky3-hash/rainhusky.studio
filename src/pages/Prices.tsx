...
const pricingTiers = [
  {
    name: "Portrait",
    price: 75,
    description: "Perfect for personal avatars and character portraits",
    features: [
      "Single character bust/headshot",
      "Simple background",
      "2 revision rounds",
  ...
  },
  {
    name: "Illustration",
    price: 100,
    description: "Scenic artwork or detailed character pieces",
    features: [
      "Single character full body OR scene",
      "Detailed background",
      "3 revision rounds",
      "High-resolution files + PSD",
      "7-10 day turnaround",
  ...
  },
  {
    name: "Commercial",
    price: 200,
    description: "Artwork for business and commercial use",
    features: [
      "Complex illustration or design",
    ...
    <Layout>
      ...
      <section className="py-12">
        <div className="container mx-auto px-6">
            ...
            {pricingTiers.map((tier) => (
              <div
                ...
                className={`relative p-6 bg-card rounded-lg border ${
                  tier.popular ? "border-primary shadow-gold" : "border-border"
                }`}
              >
                {tier.popular && (
          ...
          {/* Terms Notice */}
          <div className="mt-16 p-6 bg-card rounded-lg border border-border text-center max-w-2xl mx-auto">
            <h3 className="font-display text-lg font-medium text-foreground mb-2">
              Before You Commission
            </h3>
            <p className="text-sm text-muted-foreground mb-4">
              Please review the commission terms to understand the process, 
              payment schedule, and usage rights.
            </p>
          ...
          <div className="mt-16 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Have questions? Feel free to reach out before submitting a request.
            </p>
